...
app.use(
  busboy({
    limits: { files: 10, fileSize: 20480, highWaterMark: 20 * 1024 * 1024 },
  })
); //-------------Settting size here
...
const commonRoutes = require("./src/routes/basic_routes/common_api_routes")(
  router
);
app.use("/api/common", commonRoutes);

const providerCategoryRoutes =
  require("./src/routes/service_provider_routes/service_provider_category_routes")(
    router
  );
app.use("/api/category", providerCategoryRoutes);

const providerExpertiseRoutes =
  require("./src/routes/service_provider_routes/service_provider_expertise_routes")(
    router
  );
app.use("/api/expertise", providerExpertiseRoutes);

const providerRoutes =
  require("./src/routes/service_provider_routes/service_provider_routes")(
    router
  );
app.use("/api/provider", providerRoutes);

const clientRequestRoutes =
  require("./src/routes/service_provider_routes/client_request_routes")(router);
app.use("/api/provider", clientRequestRoutes);

const receiverRoutes =
  require("./src/routes/service_receiver_routes/service_receiver.routes")(
    router
  );
app.use("/api/receiver", receiverRoutes);

const vendorRequestRoutes =
  require("./src/routes/service_receiver_routes/vendor_bank_req.routes")(
    router
  );
app.use("/api/receiver", vendorRequestRoutes);

const vendorBankRoutes =
  require("./src/routes/service_receiver_routes/vendor_bank.routes")(router);
app.use("/api/receiver", vendorBankRoutes);

const service_provider_admin =
  require("./src/routes/Reports/serviceProviderReport.routes")(router);
app.use("/api/service_provider_admin", service_provider_admin);

const service_receiver_admin =
  require("./src/routes/Reports/serviceReceiverReport.routes")(router);
app.use("/api/service_receiver_admin", service_receiver_admin);

const tender_routes = require("./src/routes/tender/tender_registration.routes")(
  router
);
app.use("/api/tender", tender_routes);

const tender_application_routes =
  require("./src/routes/tender/tender_application_routes")(router);
app.use("/api/tender", tender_application_routes);

const project_routes =
  require("./src/routes/service_receiver_routes/project_registartion.routes")(
    router
  );
app.use("/api/project", project_routes);

const razorpay_routes = require("./src/routes/basic_routes/razorpay_order")(
  router
);
